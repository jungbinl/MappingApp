...
sf_even_h = [f"SF{i}" for i in range(44, 10, -2)] + ['SF-2']
sf_even_r1 = ["Water", "1888", "1855", "1955", "1918", "1882", "1920", "1841", "888", "1004_1", "1538", "1954", ""]
sf_even_r2 = ["", "1859", "1003_1", "344", "1478", "1937", "", "", "", "", "", "", ""]

sf_odd_h = [f"SF{i}" for i in range(43, 10, -2)] + ['SF-3', 'SF-1']
sf_odd_r1 = ["1948", "1863", "1883", "1825", "1932", "1935", "1952", "1593", "1947", "1917", "1862", "", ""]
sf_odd_r2 = ["", "1002_1", "1675", "", "1785", "", "", "", "", "", "", "", ""]

# 3. NF 구역 데이터 쪼개기 (짝수 / 홀수 분리 가공)
nf_even_h = [f"NF{i}" for i in range(44, 10, -2)] + ['NF-2']
nf_even_r1 = ["5120", "5122", "5124", "5126", "5127", "5129", "5131", "5133", "5135", "5137", "5139", "5141", ""]
nf_even_r2 = ["", "4122", "4124", "", "4127", "4129", "4131", "4133", "", "", "", "", ""]

nf_odd_h = [f"NF{i}" for i in range(43, 10, -2)] + ['NF-3', 'NF-1']
